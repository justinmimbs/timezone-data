...
rules_Edm : List Rule
rules_Edm =
    [ Rule 1969 1969 Apr (Last Sun) 120 WallClock 60
    , Rule 1969 1969 Oct (Last Sun) 120 WallClock 0
...
rules_Palestine =
    ...
    , Rule 2016 maxYear Mar (First Sat 22) 60 WallClock 60
...
rules_Turkey =
    ...
    , Rule 1974 1974 Nov (Day 3) 300 WallClock 0
    ...
    , Rule 1985 1985 Apr (Day 20) 0 WallClock 60
    , Rule 1985 1985 Sep (Day 28) 0 WallClock 0
...
rules_Zion =
    [ Rule 1974 1974 Jul (Day 7) 0 WallClock 60
    , Rule 1974 1974 Oct (Day 13) 0 WallClock 0
    , Rule 1975 1975 Apr (Day 20) 0 WallClock 60
    , Rule 1975 1975 Aug (Day 31) 0 WallClock 0
    , Rule 1985 1985 Apr (Day 14) 0 WallClock 60
    , Rule 1985 1985 Sep (Day 15) 0 WallClock 0
    , Rule 1986 1986 May (Day 18) 0 WallClock 60
    , Rule 1986 1986 Sep (Day 7) 0 WallClock 0
    , Rule 1987 1987 Apr (Day 15) 0 WallClock 60
    , Rule 1987 1987 Sep (Day 13) 0 WallClock 0
    , Rule 1988 1988 Apr (Day 10) 0 WallClock 60
    , Rule 1988 1988 Sep (Day 4) 0 WallClock 0
    , Rule 1989 1989 Apr (Day 30) 0 WallClock 60
    , Rule 1989 1989 Sep (Day 3) 0 WallClock 0
    , Rule 1990 1990 Mar (Day 25) 0 WallClock 60
    , Rule 1990 1990 Aug (Day 26) 0 WallClock 0
    , Rule 1991 1991 Mar (Day 24) 0 WallClock 60
    , Rule 1991 1991 Sep (Day 1) 0 WallClock 0
    , Rule 1992 1992 Mar (Day 29) 0 WallClock 60
    , Rule 1992 1992 Sep (Day 6) 0 WallClock 0
    ...
    , Rule 1996 1996 Mar (Day 15) 0 WallClock 60
    , Rule 1996 1996 Sep (Day 16) 0 WallClock 0
    , Rule 1997 1997 Mar (Day 21) 0 WallClock 60
    , Rule 1997 1997 Sep (Day 14) 0 WallClock 0
...
america__grand_turk =
    Packed <|
        Zone
            ...
            , ( ZoneState -300 (Rules rules_US), DateTime 2015 Nov 1 120 WallClock )
...
australia__currie =
    Packed <|
        Zone
            [ ( ZoneState 600 (Save 0), DateTime 1971 Jul 1 0 WallClock )
            ]
...
europe__istanbul =
    Packed <|
        Zone
            [ ( ZoneState 120 (Rules rules_Turkey), DateTime 1978 Oct 15 0 WallClock )
            , ( ZoneState 180 (Rules rules_Turkey), DateTime 1985 Apr 20 0 WallClock )
...
pacific__norfolk =
    Packed <|
        Zone
            [ ( ZoneState 690 (Save 0), DateTime 1974 Oct 27 120 WallClock )
            , ( ZoneState 690 (Save 60), DateTime 1975 Mar 2 120 WallClock )
            , ( ZoneState 690 (Save 0), DateTime 2015 Oct 4 120 WallClock )
            ]
            (ZoneState 660 (Save 0))
