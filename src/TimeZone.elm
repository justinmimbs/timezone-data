...
{-| This library provides time zone data from the `2023b` release of the IANA
Time Zone Database.
...
rules_Lebanon =
    ...
    , Rule 1993 2022 Mar (Last Sun) 0 WallClock 60
    , Rule 1993 1998 Sep (Last Sun) 0 WallClock 0
    , Rule 1999 maxYear Oct (Last Sun) 0 WallClock 0
    , Rule 2023 2023 Apr (Day 21) 0 WallClock 60
    , Rule 2024 maxYear Mar (Last Sun) 0 WallClock 60
    ]
