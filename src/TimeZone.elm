...
{-| This library provides time zone data from the `2019b` release of the IANA
Time Zone Database.
...
rules_Palestine =
    ...
    , Rule 2019 maxYear Mar (Last Fri) 0 WallClock 60
    ]
...
rules_Zion =
    ...
    , Rule 1980 1980 Aug (Day 2) 0 WallClock 60
    , Rule 1980 1980 Sep (Day 13) 60 WallClock 0
    , Rule 1984 1984 May (Day 5) 0 WallClock 60
    , Rule 1984 1984 Aug (Day 25) 60 WallClock 0
