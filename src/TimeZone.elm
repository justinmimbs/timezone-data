...
{-| This library provides time zone data from the `2023c` release of the IANA
Time Zone Database.
...
zones =
    ...
    --  "Links"
    , ( "Africa/Accra", africa__abidjan )
    , ( "Africa/Addis_Ababa", africa__nairobi )
    , ( "Africa/Asmara", africa__nairobi )
    , ( "Africa/Bamako", africa__abidjan )
    , ( "Africa/Bangui", africa__lagos )
    , ( "Africa/Banjul", africa__abidjan )
    , ( "Africa/Blantyre", africa__maputo )
    , ( "Africa/Brazzaville", africa__lagos )
    , ( "Africa/Bujumbura", africa__maputo )
    , ( "Africa/Conakry", africa__abidjan )
    , ( "Africa/Dakar", africa__abidjan )
    , ( "Africa/Dar_es_Salaam", africa__nairobi )
    , ( "Africa/Djibouti", africa__nairobi )
    , ( "Africa/Douala", africa__lagos )
    , ( "Africa/Freetown", africa__abidjan )
    , ( "Africa/Gaborone", africa__maputo )
    , ( "Africa/Harare", africa__maputo )
    , ( "Africa/Kampala", africa__nairobi )
    , ( "Africa/Kigali", africa__maputo )
    , ( "Africa/Kinshasa", africa__lagos )
    , ( "Africa/Libreville", africa__lagos )
    , ( "Africa/Lome", africa__abidjan )
    , ( "Africa/Luanda", africa__lagos )
    , ( "Africa/Lubumbashi", africa__maputo )
    , ( "Africa/Lusaka", africa__maputo )
    , ( "Africa/Malabo", africa__lagos )
    , ( "Africa/Maseru", africa__johannesburg )
    , ( "Africa/Mbabane", africa__johannesburg )
    , ( "Africa/Mogadishu", africa__nairobi )
    , ( "Africa/Niamey", africa__lagos )
    , ( "Africa/Nouakchott", africa__abidjan )
    , ( "Africa/Ouagadougou", africa__abidjan )
    , ( "Africa/Porto-Novo", africa__lagos )
    , ( "Africa/Timbuktu", africa__abidjan )
    , ( "America/Anguilla", america__puerto_rico )
    , ( "America/Antigua", america__puerto_rico )
    , ( "America/Aruba", america__puerto_rico )
    , ( "America/Atikokan", america__panama )
    , ( "America/Blanc-Sablon", america__puerto_rico )
    , ( "America/Cayman", america__panama )
    , ( "America/Coral_Harbour", america__panama )
    , ( "America/Creston", america__phoenix )
    , ( "America/Curacao", america__puerto_rico )
    , ( "America/Dominica", america__puerto_rico )
    , ( "America/Ensenada", america__tijuana )
    , ( "America/Grenada", america__puerto_rico )
    , ( "America/Guadeloupe", america__puerto_rico )
    , ( "America/Montreal", america__toronto )
    , ( "America/Montserrat", america__puerto_rico )
    , ( "America/Nassau", america__toronto )
    , ( "America/Nipigon", america__toronto )
    , ( "America/Pangnirtung", america__iqaluit )
    , ( "America/Port_of_Spain", america__puerto_rico )
    , ( "America/Rainy_River", america__winnipeg )
    , ( "America/St_Kitts", america__puerto_rico )
    , ( "America/St_Lucia", america__puerto_rico )
    , ( "America/St_Thomas", america__puerto_rico )
    , ( "America/St_Vincent", america__puerto_rico )
    , ( "America/Thunder_Bay", america__toronto )
    , ( "America/Tortola", america__puerto_rico )
    , ( "America/Yellowknife", america__edmonton )
    , ( "Antarctica/DumontDUrville", pacific__port_moresby )
    , ( "Antarctica/McMurdo", pacific__auckland )
    , ( "Antarctica/Syowa", asia__riyadh )
    , ( "Antarctica/Vostok", asia__urumqi )
    , ( "Asia/Aden", asia__riyadh )
    , ( "Asia/Bahrain", asia__qatar )
    , ( "Asia/Brunei", asia__kuching )
    , ( "Asia/Chongqing", asia__shanghai )
    , ( "Asia/Harbin", asia__shanghai )
    , ( "Asia/Kashgar", asia__urumqi )
    , ( "Asia/Kuala_Lumpur", asia__singapore )
    , ( "Asia/Kuwait", asia__riyadh )
    , ( "Asia/Muscat", asia__dubai )
    , ( "Asia/Phnom_Penh", asia__bangkok )
    , ( "Asia/Tel_Aviv", asia__jerusalem )
    , ( "Asia/Vientiane", asia__bangkok )
    , ( "Atlantic/Jan_Mayen", europe__berlin )
    , ( "Atlantic/Reykjavik", africa__abidjan )
    , ( "Atlantic/St_Helena", africa__abidjan )
    , ( "Australia/Currie", australia__hobart )
    , ( "Europe/Amsterdam", europe__brussels )
    , ( "Europe/Belfast", europe__london )
    , ( "Europe/Copenhagen", europe__berlin )
    , ( "Europe/Guernsey", europe__london )
    , ( "Europe/Isle_of_Man", europe__london )
    , ( "Europe/Jersey", europe__london )
    , ( "Europe/Ljubljana", europe__belgrade )
    , ( "Europe/Luxembourg", europe__brussels )
    , ( "Europe/Monaco", europe__paris )
    , ( "Europe/Oslo", europe__berlin )
    , ( "Europe/Sarajevo", europe__belgrade )
    , ( "Europe/Skopje", europe__belgrade )
    , ( "Europe/Stockholm", europe__berlin )
    , ( "Europe/Tiraspol", europe__chisinau )
    , ( "Europe/Uzhgorod", europe__kyiv )
    , ( "Europe/Vaduz", europe__zurich )
    , ( "Europe/Zagreb", europe__belgrade )
    , ( "Europe/Zaporozhye", europe__kyiv )
    , ( "Indian/Antananarivo", africa__nairobi )
    , ( "Indian/Christmas", asia__bangkok )
    , ( "Indian/Cocos", asia__yangon )
    , ( "Indian/Comoro", africa__nairobi )
    , ( "Indian/Kerguelen", indian__maldives )
    , ( "Indian/Mahe", asia__dubai )
    , ( "Indian/Mayotte", africa__nairobi )
    , ( "Indian/Reunion", asia__dubai )
    , ( "Pacific/Chuuk", pacific__port_moresby )
    , ( "Pacific/Enderbury", pacific__kanton )
    , ( "Pacific/Funafuti", pacific__tarawa )
    , ( "Pacific/Johnston", pacific__honolulu )
    , ( "Pacific/Majuro", pacific__tarawa )
    , ( "Pacific/Midway", pacific__pago_pago )
    , ( "Pacific/Pohnpei", pacific__guadalcanal )
    , ( "Pacific/Saipan", pacific__guam )
    , ( "Pacific/Wake", pacific__tarawa )
    , ( "Pacific/Wallis", pacific__tarawa )
    , ( "Africa/Asmera", africa__nairobi )
    , ( "America/Atka", america__adak )
    , ( "America/Godthab", america__nuuk )
    , ( "America/Kralendijk", america__puerto_rico )
    , ( "America/Lower_Princes", america__puerto_rico )
    , ( "America/Marigot", america__puerto_rico )
    , ( "America/Porto_Acre", america__rio_branco )
    , ( "America/Santa_Isabel", america__tijuana )
    , ( "America/Shiprock", america__denver )
    , ( "America/St_Barthelemy", america__puerto_rico )
    , ( "America/Virgin", america__puerto_rico )
    , ( "Antarctica/South_Pole", pacific__auckland )
    , ( "Arctic/Longyearbyen", europe__berlin )
    , ( "Asia/Ashkhabad", asia__ashgabat )
    , ( "Asia/Calcutta", asia__kolkata )
    , ( "Asia/Chungking", asia__shanghai )
    , ( "Asia/Dacca", asia__dhaka )
    , ( "Asia/Istanbul", europe__istanbul )
    , ( "Asia/Katmandu", asia__kathmandu )
    , ( "Asia/Macao", asia__macau )
    , ( "Asia/Rangoon", asia__yangon )
    , ( "Asia/Saigon", asia__ho_chi_minh )
    , ( "Asia/Thimbu", asia__thimphu )
    , ( "Asia/Ujung_Pandang", asia__makassar )
    , ( "Asia/Ulan_Bator", asia__ulaanbaatar )
    , ( "Atlantic/Faeroe", atlantic__faroe )
    , ( "Australia/ACT", australia__sydney )
    , ( "Australia/Canberra", australia__sydney )
    , ( "Australia/LHI", australia__lord_howe )
    , ( "Australia/North", australia__darwin )
    , ( "Australia/NSW", australia__sydney )
    , ( "Australia/Queensland", australia__brisbane )
    , ( "Australia/South", australia__adelaide )
    , ( "Australia/Tasmania", australia__hobart )
    , ( "Australia/Victoria", australia__melbourne )
    , ( "Australia/West", australia__perth )
    , ( "Australia/Yancowinna", australia__broken_hill )
    , ( "Brazil/Acre", america__rio_branco )
    , ( "Brazil/DeNoronha", america__noronha )
    , ( "Brazil/East", america__sao_paulo )
    , ( "Brazil/West", america__manaus )
    , ( "Canada/Atlantic", america__halifax )
    , ( "Canada/Central", america__winnipeg )
    , ( "Canada/Eastern", america__toronto )
    , ( "Canada/Mountain", america__edmonton )
    , ( "Canada/Newfoundland", america__st_johns )
    , ( "Canada/Pacific", america__vancouver )
    , ( "Canada/Saskatchewan", america__regina )
    , ( "Canada/Yukon", america__whitehorse )
    , ( "Chile/Continental", america__santiago )
    , ( "Chile/EasterIsland", pacific__easter )
    , ( "Cuba", america__havana )
    , ( "Egypt", africa__cairo )
    , ( "Eire", europe__dublin )
    , ( "Europe/Bratislava", europe__prague )
    , ( "Europe/Busingen", europe__zurich )
    , ( "Europe/Kiev", europe__kyiv )
    , ( "Europe/Mariehamn", europe__helsinki )
    , ( "Europe/Nicosia", asia__nicosia )
    , ( "Europe/Podgorica", europe__belgrade )
    , ( "Europe/San_Marino", europe__rome )
    , ( "Europe/Vatican", europe__rome )
    , ( "GB", europe__london )
    , ( "GB-Eire", europe__london )
    , ( "Hongkong", asia__hong_kong )
    , ( "Iceland", africa__abidjan )
    , ( "Iran", asia__tehran )
    , ( "Israel", asia__jerusalem )
    , ( "Jamaica", america__jamaica )
    , ( "Japan", asia__tokyo )
    , ( "Kwajalein", pacific__kwajalein )
    , ( "Libya", africa__tripoli )
    , ( "Mexico/BajaNorte", america__tijuana )
    , ( "Mexico/BajaSur", america__mazatlan )
    , ( "Mexico/General", america__mexico_city )
    , ( "Navajo", america__denver )
    , ( "NZ", pacific__auckland )
    , ( "NZ-CHAT", pacific__chatham )
    , ( "Pacific/Ponape", pacific__guadalcanal )
    , ( "Pacific/Samoa", pacific__pago_pago )
    , ( "Pacific/Truk", pacific__port_moresby )
    , ( "Pacific/Yap", pacific__port_moresby )
    , ( "Poland", europe__warsaw )
    , ( "Portugal", europe__lisbon )
    , ( "PRC", asia__shanghai )
    , ( "ROC", asia__taipei )
    , ( "ROK", asia__seoul )
    , ( "Singapore", asia__singapore )
    , ( "Turkey", europe__istanbul )
    , ( "US/Alaska", america__anchorage )
    , ( "US/Aleutian", america__adak )
    , ( "US/Arizona", america__phoenix )
    , ( "US/Central", america__chicago )
    , ( "US/Eastern", america__new_york )
    , ( "US/Hawaii", pacific__honolulu )
    , ( "US/Michigan", america__detroit )
    , ( "US/Mountain", america__denver )
    , ( "US/Pacific", america__los_angeles )
    , ( "US/Samoa", pacific__pago_pago )
    , ( "W-SU", europe__moscow )

    -- Links
    , ( "US/East-Indiana", america__indiana__indianapolis )
    , ( "US/Indiana-Starke", america__indiana__knox )
    , ( "America/Argentina/ComodRivadavia", america__argentina__catamarca )
    , ( "America/Rosario", america__argentina__cordoba )
    , ( "America/Buenos_Aires", america__argentina__buenos_aires )
    , ( "America/Catamarca", america__argentina__catamarca )
    , ( "America/Cordoba", america__argentina__cordoba )
    , ( "America/Fort_Wayne", america__indiana__indianapolis )
    , ( "America/Indianapolis", america__indiana__indianapolis )
    , ( "America/Jujuy", america__argentina__jujuy )
    , ( "America/Knox_IN", america__indiana__knox )
    , ( "America/Louisville", america__kentucky__louisville )
    , ( "America/Mendoza", america__argentina__mendoza )
    ]
        |> Dict.fromList
...
rules_Palestine =
    ...
    , Rule 2024 2024 Apr (Day 13) 120 WallClock 60
    , Rule 2025 2025 Apr (Day 5) 120 WallClock 60
...
america__nuuk _ =
    fromSpecification <|
        Zone
            [ ( ZoneState -180 (Save 0), DateTime 1980 Apr 6 120 WallClock )
            , ( ZoneState -180 (Rules rules_EU), DateTime 2023 Oct 29 60 Universal )
            ]
